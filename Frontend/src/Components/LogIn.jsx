        ...
        <div className="bg-[var(--cardbg)] shadow-[0_4px_7px_1px_var(--cardshadow)] rounded-2xl p-6">
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center hover:text-[var(--demohead)] transition-colors cursor-pointer"
                >
                  {showPassword ? (
            ...
            <div className="text-sm">
              <a
                href="#"
                className="font-medium text-[var(--carddscp)] hover:text-[var(--demohead)] transition-colors"
              >
